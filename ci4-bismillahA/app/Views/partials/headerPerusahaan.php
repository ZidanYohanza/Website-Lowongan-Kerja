...
<div class="header">
    <a href="/" class="header-logo"><strong> Cari Kerja Kuy </strong></a>
    <div class="header-list">
    <?php $isActivePage = fn($x) => uri_string() == $x ? 'active' : ''; ?>
        <span class = "navLis">
            <strong>
                <br>
                <a href="" <?= $isActivePage('/'); ?> class="lis">Beranda</a>
                <a href="" <?= $isActivePage('/'); ?> class="lis">Perusahaan</a>
                <a href="" <?= $isActivePage('/'); ?> class="lis">About Me</a>
            </strong>
        </span>
        <span class ="tombol">
            <a href="/logout" class="btn" style="color: #ffff;">Logout</a>
            <a href="/indexPerusahaan" class="btn" style="color: #ffff;">Profil</a>
        </span>
    </div>
</div>
